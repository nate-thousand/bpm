import { average, standardDeviation, confidenceLabel } from "./audio-utils"
import { LOCK, META } from "./terminal-copy"
import type { TapStats } from "./types"
...
export function recordTap(now: number = performance.now()): TapStats {
...
export function resetTapBpm(): TapStats {
  taps = []
  smoothedBpm = 0
  return getTapStats()
}

export function calculateTapBpm(): number {
